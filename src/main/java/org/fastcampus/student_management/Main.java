...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // 기본 default 세팅 추가
        StudentInfoDto studentInfoDto = new StudentInfoDto("홍길동", 20, "gangnam");
        StudentInfoDto studentInfoDto1 = new StudentInfoDto("임껵정", 21, "nowon");
        ...
        CourseInfoDto courseInfoDto1 = new CourseInfoDto("첼로", 1000, "MONDAY", "임껵정", 1717299008L);
